...
"SA for tweets"
###################
setwd("/home/cris/mrcrstnherediagmez@gmail.com/Countwords/Twitter-Sentimental-Analysis-master")
...
#then try the oter methods
container=create_container(mat,as.numeric(sentiment_all),trainSize = 1:160,testSize = 161:180,virgin = FALSE)
